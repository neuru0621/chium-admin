...
import LogSearchBar from "@/components/LogListC/LogSearchBar"
import LogTable from "@/components/LogListC/LogTable"
...
export default {
  ...
  watch: {
    $route(to) {
      ...
      this.controlQuerySetAndGetLogList(to)
    }
  },
  created(){
